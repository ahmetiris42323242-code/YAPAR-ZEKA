...
if prompt := st.chat_input("Sorunuzu buraya yazın..."):
    ...
    with st.chat_message("assistant"):
        ...
        # FİLTRE 2: AHMET İRİŞ KİMDİR SORUSU (KİMLİK KORUMASI)
        elif "ahmet iriş kimdir" in temiz_girdi or "ahmet iriş kim" in temiz_girdi or "ahmet iris kim" in temiz_girdi:
            answer = "Ahmet İRİŞ, bu harika web tabanlı yapay zeka asistanı projesinin arkasındaki asıl geliştirici, kurucu ve liderdir! 🚀 Ben ise onun tasarlayıp kodladığı, kullanıcılarına yardımcı olan yapay zeka asistanıyım. Yani o bu sistemin mimarı, ben ise onun asistanıyım! 😎👨‍💻"
            message_placeholder.markdown(answer)
            st.session_state.messages.append({"role": "assistant", "content": answer})
            ...
            try:
                system_instruction = (
                    ...
                    "Kullanıcıya kesinlikle 'siz', 'sizin' veya 'bize' diyerek resmi konuşma! "
                    "Her zaman samimi bir arkadaş gibi 'sen' ve 'senin' diye hitap et. "
